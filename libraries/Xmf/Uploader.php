 ...
 *  }
 * </pre>
 * <strong>How to process a file uploaded via XMLHttpRequest?</strong><br>
 ...
 *  die();
 * </pre>
 * <strong>Processing parameters</strong> (reset after each process)
 * <ul>
 *  <li><strong>{@link file_new_name_body}</strong> replaces the name body (default: null)<br>
 *  <pre>$handle->file_new_name_body = 'new name';</pre></li>
 *  <li><strong>{@link file_name_body_add}</strong> appends to the name body (default: null)<br>
 *  <pre>$handle->file_name_body_add = '_uploaded';</pre></li>
 *  <li><strong>{@link file_name_body_pre}</strong> prepends to the name body (default: null)<br>
 *  <pre>$handle->file_name_body_pre = 'thumb_';</pre></li>
 *  <li><strong>{@link file_new_name_ext}</strong> replaces the file extension (default: null)<br>
 *  <pre>$handle->file_new_name_ext = 'txt';</pre></li>
 *  <li><strong>{@link file_safe_name}</strong> formats the filename (spaces changed to _) (default: true)<br>
 *  <pre>$handle->file_safe_name = true;</pre></li>
 *  <li><strong>{@link file_force_extension}</strong> forces an extension if there is't any (default: true)<br>
 *  <pre>$handle->file_force_extension = true;</pre></li>
 *  <li><strong>{@link file_overwrite}</strong> sets behaviour if file already exists (default: false)<br>
 *  <pre>$handle->file_overwrite = true;</pre></li>
 *  <li><strong>{@link file_auto_rename}</strong> automatically renames file if it already exists (default: true)<br>
 *  <pre>$handle->file_auto_rename = true;</pre></li>
 *  <li><strong>{@link dir_auto_create}</strong> automatically creates destination directory if missing (default: true)<br>
 *  <pre>$handle->auto_create_dir = true;</pre></li>
 *  <li><strong>{@link dir_auto_chmod}</strong> automatically attempts to chmod the destination directory if not writeable (default: true)<br>
 *  <pre>$handle->dir_auto_chmod = true;</pre></li>
 *  <li><strong>{@link dir_chmod}</strong> chmod used when creating directory or if directory not writeable (default: 0777)<br>
 *  <pre>$handle->dir_chmod = 0777;</pre></li>
 *  <li><strong>{@link file_max_size}</strong> sets maximum upload size (default: upload_max_filesize from php.ini)<br>
 *  <pre>$handle->file_max_size = '1024'; // 1KB</pre></li>
 *  <li><strong>{@link mime_check}</strong> sets if the class check the MIME against the {@link allowed} list (default: true)<br>
 *  <pre>$handle->mime_check = true;</pre></li>
 *  <li><strong>{@link no_script}</strong> sets if the class turns scripts into text files (default: true)<br>
 *  <pre>$handle->no_script = false;</pre></li>
 *  <li><strong>{@link allowed}</strong> array of allowed mime-types (or one string). wildcard accepted, as in image/* (default: check {@link Init})<br>
 *  <pre>$handle->allowed = array('application/pdf','application/msword', 'image/*');</pre></li>
 *  <li><strong>{@link forbidden}</strong> array of forbidden mime-types (or one string). wildcard accepted, as in image/*  (default: check {@link Init})<br>
 *  <pre>$handle->forbidden = array('application/*');</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>{@link image_convert}</strong> if set, image will be converted (possible values : ''|'png'|'jpeg'|'gif'|'bmp'; default: '')<br>
 *  <pre>$handle->image_convert = 'jpg';</pre></li>
 *  <li><strong>{@link image_background_color}</strong> if set, will forcibly fill transparent areas with the color, in hexadecimal (default: null)<br>
 *  <pre>$handle->image_background_color = '#FF00FF';</pre></li>
 *  <li><strong>{@link image_default_color}</strong> fallback color background color for non alpha-transparent output formats, such as JPEG or BMP, in hexadecimal (default: #FFFFFF)<br>
 *  <pre>$handle->image_default_color = '#FF00FF';</pre></li>
 *  <li><strong>{@link png_compression}</strong> sets the compression level for PNG images, between 1 (fast but large files) and 9 (slow but smaller files) (default: null (Zlib default))<br>
 *  <pre>$handle->png_compression = 9;</pre></li>
 *  <li><strong>{@link jpeg_quality}</strong> sets the compression quality for JPEG images (default: 85)<br>
 *  <pre>$handle->jpeg_quality = 50;</pre></li>
 *  <li><strong>{@link jpeg_size}</strong> if set to a size in bytes, will approximate {@link jpeg_quality} so the output image fits within the size (default: null)<br>
 *  <pre>$handle->jpeg_size = 3072;</pre></li>
 *  <li><strong>{@link image_interlace}</strong> if set to true, the image will be saved interlaced (default: false)<br>
 ...
 * <ul>
 *  <li><strong>{@link image_max_width}</strong> if set to a dimension in pixels, the upload will be invalid if the image width is greater (default: null)<br>
 *  <pre>$handle->image_max_width = 200;</pre></li>
 *  <li><strong>{@link image_max_height}</strong> if set to a dimension in pixels, the upload will be invalid if the image height is greater (default: null)<br>
 *  <pre>$handle->image_max_height = 100;</pre></li>
 *  <li><strong>{@link image_max_pixels}</strong> if set to a number of pixels, the upload will be invalid if the image number of pixels is greater (default: null)<br>
 *  <pre>$handle->image_max_pixels = 50000;</pre></li>
 *  <li><strong>{@link image_max_ratio}</strong> if set to a aspect ratio (width/height), the upload will be invalid if the image apect ratio is greater (default: null)<br>
 *  <pre>$handle->image_max_ratio = 1.5;</pre></li>
 *  <li><strong>{@link image_min_width}</strong> if set to a dimension in pixels, the upload will be invalid if the image width is lower (default: null)<br>
 *  <pre>$handle->image_min_width = 100;</pre></li>
 *  <li><strong>{@link image_min_height}</strong> if set to a dimension in pixels, the upload will be invalid if the image height is lower (default: null)<br>
 *  <pre>$handle->image_min_height = 500;</pre></li>
 *  <li><strong>{@link image_min_pixels}</strong> if set to a number of pixels, the upload will be invalid if the image number of pixels is lower (default: null)<br>
 *  <pre>$handle->image_min_pixels = 20000;</pre></li>
 *  <li><strong>{@link image_min_ratio}</strong> if set to a aspect ratio (width/height), the upload will be invalid if the image apect ratio is lower (default: null)<br>
 *  <pre>$handle->image_min_ratio = 0.5;</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>{@link image_resize}</strong> determines is an image will be resized (default: false)<br>
 *  <pre>$handle->image_resize = true;</pre></li>
 * </ul>
 *  The following variables are used only if {@link image_resize} == true
 * <ul>
 *  <li><strong>{@link image_x}</strong> destination image width (default: 150)<br>
 *  <pre>$handle->image_x = 100;</pre></li>
 *  <li><strong>{@link image_y}</strong> destination image height (default: 150)<br>
 *  <pre>$handle->image_y = 200;</pre></li>
 * </ul>
 *  Use either one of the following
 * <ul>
 *  <li><strong>{@link image_ratio}</strong> if true, resize image conserving the original sizes ratio, using {@link image_x} AND {@link image_y} as max sizes if true (default: false)<br>
 *  <pre>$handle->image_ratio = true;</pre></li>
 *  <li><strong>{@link image_ratio_crop}</strong> if true, resize image conserving the original sizes ratio, using {@link image_x} AND {@link image_y} as max sizes, and cropping excedent to fill the space. setting can also be a string, with one or more from 'TBLR', indicating which side of the image will be kept while cropping (default: false)<br>
 *  <pre>$handle->image_ratio_crop = true;</pre></li>
 *  <li><strong>{@link image_ratio_fill}</strong> if true, resize image conserving the original sizes ratio, using {@link image_x} AND {@link image_y} as max sizes, fitting the image in the space and coloring the remaining space. setting can also be a string, with one or more from 'TBLR', indicating which side of the space the image will be in (default: false)<br>
 *  <pre>$handle->image_ratio_fill = true;</pre></li>
 *  <li><strong>{@link image_ratio_no_zoom_in}</strong> same as {@link image_ratio}, but won't resize if the source image is smaller than {@link image_x} x {@link image_y} (default: false)<br>
 *  <pre>$handle->image_ratio_no_zoom_in = true;</pre></li>
 *  <li><strong>{@link image_ratio_no_zoom_out}</strong> same as {@link image_ratio}, but won't resize if the source image is bigger than {@link image_x} x {@link image_y} (default: false)<br>
 *  <pre>$handle->image_ratio_no_zoom_out = true;</pre></li>
 *  <li><strong>{@link image_ratio_x}</strong> if true, resize image, calculating {@link image_x} from {@link image_y} and conserving the original sizes ratio (default: false)<br>
 *  <pre>$handle->image_ratio_x = true;</pre></li>
 *  <li><strong>{@link image_ratio_y}</strong> if true, resize image, calculating {@link image_y} from {@link image_x} and conserving the original sizes ratio (default: false)<br>
 *  <pre>$handle->image_ratio_y = true;</pre></li>
 *  <li><strong>{@link image_ratio_pixels}</strong> if set to a long integer, resize image, calculating {@link image_y} and {@link image_x} to match a the number of pixels (default: false)<br>
 *  <pre>$handle->image_ratio_pixels = 25000;</pre></li>
 * </ul>
 *  The following image manipulations require GD2+
 * <ul>
 *  <li><strong>{@link image_brightness}</strong> if set, corrects the brightness. value between -127 and 127 (default: null)<br>
 *  <pre>$handle->image_brightness = 40;</pre></li>
 *  <li><strong>{@link image_contrast}</strong> if set, corrects the contrast. value between -127 and 127 (default: null)<br>
 *  <pre>$handle->image_contrast = 50;</pre></li>
 *  <li><strong>{@link image_opacity}</strong> if set, changes the image opacity. value between 0 and 100 (default: null)<br>
 *  <pre>$handle->image_opacity = 50;</pre></li>
 *  <li><strong>{@link image_tint_color}</strong> if set, will tint the image with a color, value as hexadecimal #FFFFFF (default: null)<br>
 *  <pre>$handle->image_tint_color = '#FF0000';</pre></li>
 *  <li><strong>{@link image_overlay_color}</strong> if set, will add a colored overlay, value as hexadecimal #FFFFFF (default: null)<br>
 *  <pre>$handle->image_overlay_color = '#FF0000';</pre></li>
 *  <li><strong>{@link image_overlay_opacity}</strong> used when {@link image_overlay_color} is set, determines the opacity (default: 50)<br>
 *  <pre>$handle->image_overlay_opacity = 20;</pre></li>
 *  <li><strong>{@link image_negative}</strong> inverts the colors in the image (default: false)<br>
 *  <pre>$handle->image_negative = true;</pre></li>
 *  <li><strong>{@link image_greyscale}</strong> transforms an image into greyscale (default: false)<br>
 *  <pre>$handle->image_greyscale = true;</pre></li>
 *  <li><strong>{@link image_threshold}</strong> applies a threshold filter. value between -127 and 127 (default: null)<br>
 *  <pre>$handle->image_threshold = 20;</pre></li>
 *  <li><strong>{@link image_pixelate}</strong> pixelate an image, value is block size (default: null)<br>
 *  <pre>$handle->image_pixelate = 10;</pre></li>
 *  <li><strong>{@link image_unsharp}</strong> applies an unsharp mask, with alpha transparency support (default: false)<br>
 *  <pre>$handle->image_unsharp = true;</pre></li>
 *  <li><strong>{@link image_unsharp_amount}</strong> unsharp mask amount, typically 50 - 200 (default: 80)<br>
 *  <pre>$handle->image_unsharp_amount = 120;</pre></li>
 *  <li><strong>{@link image_unsharp_radius}</strong> unsharp mask radius, typically 0.5 - 1 (default: 0.5)<br>
 *  <pre>$handle->image_unsharp_radius = 1;</pre></li>
 *  <li><strong>{@link image_unsharp_threshold}</strong> unsharp mask threshold, typically 0 - 5 (default: 1)<br>
 *  <pre>$handle->image_unsharp_threshold = 0;</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>{@link image_text}</strong> creates a text label on the image, value is a string, with eventual replacement tokens (default: null)<br>
 *  <pre>$handle->image_text = 'test';</pre></li>
 *  <li><strong>{@link image_text_direction}</strong> text label direction, either 'h' horizontal or 'v' vertical (default: 'h')<br>
 *  <pre>$handle->image_text_direction = 'v';</pre></li>
 *  <li><strong>{@link image_text_color}</strong> text color for the text label, in hexadecimal (default: #FFFFFF)<br>
 *  <pre>$handle->image_text_color = '#FF0000';</pre></li>
 *  <li><strong>{@link image_text_opacity}</strong> text opacity on the text label, integer between 0 and 100 (default: 100)<br>
 *  <pre>$handle->image_text_opacity = 50;</pre></li>
 *  <li><strong>{@link image_text_background}</strong> text label background color, in hexadecimal (default: null)<br>
 *  <pre>$handle->image_text_background = '#FFFFFF';</pre></li>
 *  <li><strong>{@link image_text_background_opacity}</strong> text label background opacity, integer between 0 and 100 (default: 100)<br>
 *  <pre>$handle->image_text_background_opacity = 50;</pre></li>
 *  <li><strong>{@link image_text_font}</strong> built-in font for the text label, from 1 to 5. 1 is the smallest (default: 5)<br>
 *  <pre>$handle->image_text_font = 4;</pre></li>
 *  <li><strong>{@link image_text_x}</strong> absolute text label position, in pixels from the left border. can be negative (default: null)<br>
 *  <pre>$handle->image_text_x = 5;</pre></li>
 *  <li><strong>{@link image_text_y}</strong> absolute text label position, in pixels from the top border. can be negative (default: null)<br>
 *  <pre>$handle->image_text_y = 5;</pre></li>
 *  <li><strong>{@link image_text_position}</strong> text label position withing the image, a combination of one or two from 'TBLR': top, bottom, left, right (default: null)<br>
 *  <pre>$handle->image_text_position = 'LR';</pre></li>
 *  <li><strong>{@link image_text_padding}</strong> text label padding, in pixels. can be overridden by {@link image_text_padding_x} and {@link image_text_padding_y} (default: 0)<br>
 *  <pre>$handle->image_text_padding = 5;</pre></li>
 *  <li><strong>{@link image_text_padding_x}</strong> text label horizontal padding (default: null)<br>
 *  <pre>$handle->image_text_padding_x = 2;</pre></li>
 *  <li><strong>{@link image_text_padding_y}</strong> text label vertical padding (default: null)<br>
 *  <pre>$handle->image_text_padding_y = 10;</pre></li>
 *  <li><strong>{@link image_text_alignment}</strong> text alignment when text has multiple lines, either 'L', 'C' or 'R' (default: 'C')<br>
 *  <pre>$handle->image_text_alignment = 'R';</pre></li>
 *  <li><strong>{@link image_text_line_spacing}</strong> space between lines in pixels, when text has multiple lines (default: 0)<br>
 *  <pre>$handle->image_text_line_spacing = 3;</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>{@link image_flip}</strong> flips image, wither 'h' horizontal or 'v' vertical (default: null)<br>
 *  <pre>$handle->image_flip = 'h';</pre></li>
 *  <li><strong>{@link image_rotate}</strong> rotates image. possible values are 90, 180 and 270 (default: null)<br>
 *  <pre>$handle->image_rotate = 90;</pre></li>
 *  <li><strong>{@link image_crop}</strong> crops image. accepts 4, 2 or 1 values as 'T R B L' or 'TB LR' or 'TBLR'. dimension can be 20, or 20px or 20% (default: null)<br>
 *  <pre>$handle->image_crop = array(50,40,30,20); OR '-20 20%'...</pre></li>
 *  <li><strong>{@link image_precrop}</strong> crops image, before an eventual resizing. accepts 4, 2 or 1 values as 'T R B L' or 'TB LR' or 'TBLR'. dimension can be 20, or 20px or 20% (default: null)<br>
 *  <pre>$handle->image_precrop = array(50,40,30,20); OR '-20 20%'...</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>{@link image_bevel}</strong> adds a bevel border to the image. value is thickness in pixels (default: null)<br>
 *  <pre>$handle->image_bevel = 20;</pre></li>
 *  <li><strong>{@link image_bevel_color1}</strong> top and left bevel color, in hexadecimal (default: #FFFFFF)<br>
 *  <pre>$handle->image_bevel_color1 = '#FFFFFF';</pre></li>
 *  <li><strong>{@link image_bevel_color2}</strong> bottom and right bevel color, in hexadecimal (default: #000000)<br>
 *  <pre>$handle->image_bevel_color2 = '#000000';</pre></li>
 *  <li><strong>{@link image_border}</strong> adds a unicolor border to the image. accepts 4, 2 or 1 values as 'T R B L' or 'TB LR' or 'TBLR'. dimension can be 20, or 20px or 20% (default: null)<br>
 *  <pre>$handle->image_border = '3px'; OR '-20 20%' OR array(3,2)...</pre></li>
 *  <li><strong>{@link image_border_color}</strong> border color, in hexadecimal (default: #FFFFFF)<br>
 *  <pre>$handle->image_border_color = '#FFFFFF';</pre></li>
 *  <li><strong>{@link image_border_opacity}</strong> border opacity, integer between 0 and 100 (default: 100)<br>
 *  <pre>$handle->image_border_opacity = 50;</pre></li>
 *  <li><strong>{@link image_border_transparent}</strong> adds a fading-to-transparent border to the image. accepts 4, 2 or 1 values as 'T R B L' or 'TB LR' or 'TBLR'. dimension can be 20, or 20px or 20% (default: null)<br>
 *  <pre>$handle->image_border_transparent = '3px'; OR '-20 20%' OR array(3,2)...</pre></li>
 *  <li><strong>{@link image_frame}</strong> type of frame: 1=flat 2=crossed (default: null)<br>
 *  <pre>$handle->image_frame = 2;</pre></li>
 *  <li><strong>{@link image_frame_colors}</strong> list of hex colors, in an array or a space separated string (default: '#FFFFFF #999999 #666666 #000000')<br>
 *  <pre>$handle->image_frame_colors = array('#999999',  '#FF0000', '#666666', '#333333', '#000000');</pre></li>
 *  <li><strong>{@link image_frame_opacity}</strong> frame opacity, integer between 0 and 100 (default: 100)<br>
 *  <pre>$handle->image_frame_opacity = 50;</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>{@link image_watermark}</strong> adds a watermark on the image, value is a local filename. accepted files are GIF, JPG, BMP, PNG and PNG alpha (default: null)<br>
 *  <pre>$handle->image_watermark = 'watermark.png';</pre></li>
 *  <li><strong>{@link image_watermark_x}</strong> absolute watermark position, in pixels from the left border. can be negative (default: null)<br>
 *  <pre>$handle->image_watermark_x = 5;</pre></li>
 *  <li><strong>{@link image_watermark_y}</strong> absolute watermark position, in pixels from the top border. can be negative (default: null)<br>
 *  <pre>$handle->image_watermark_y = 5;</pre></li>
 *  <li><strong>{@link image_watermark_position}</strong> watermark position withing the image, a combination of one or two from 'TBLR': top, bottom, left, right (default: null)<br>
 *  <pre>$handle->image_watermark_position = 'LR';</pre></li>
 *  <li><strong>{@link image_watermark_no_zoom_in}</strong> prevents the watermark to be resized up if it is smaller than the image (default: true)<br>
 *  <pre>$handle->image_watermark_no_zoom_in = false;</pre></li>
 *  <li><strong>{@link image_watermark_no_zoom_out}</strong> prevents the watermark to be resized down if it is bigger than the image (default: false)<br>
 *  <pre>$handle->image_watermark_no_zoom_out = true;</pre></li>
 * </ul>
 * <ul>
 *  <li><strong>{@link image_reflection_height}</strong> if set, a reflection will be added. Format is either in pixels or percentage, such as 40, '40', '40px' or '40%' (default: null)<br>
 *  <pre>$handle->image_reflection_height = '25%';</pre></li>
 *  <li><strong>{@link image_reflection_space}</strong> space in pixels between the source image and the reflection, can be negative (default: null)<br>
 *  <pre>$handle->image_reflection_space = 3;</pre></li>
 *  <li><strong>{@link image_reflection_color}</strong> reflection background color, in hexadecimal. Now deprecated in favor of {@link image_default_color} (default: #FFFFFF)<br>
 *  <pre>$handle->image_default_color = '#000000';</pre></li>
 *  <li><strong>{@link image_reflection_opacity}</strong> opacity level at which the reflection starts, integer between 0 and 100 (default: 60)<br>
 *  <pre>$handle->image_reflection_opacity = 60;</pre></li>
 * </ul>
 * <strong>Values that can be read before calling {@link process}()</strong>
 * <ul>
 *  <li><strong>{@link file_src_name}</strong> Source file name</li>
 *  <li><strong>{@link file_src_name_body}</strong> Source file name body</li>
 *  <li><strong>{@link file_src_name_ext}</strong> Source file extension</li>
 *  <li><strong>{@link file_src_pathname}</strong> Source file complete path and name</li>
 *  <li><strong>{@link file_src_mime}</strong> Source file mime type</li>
 *  <li><strong>{@link file_src_size}</strong> Source file size in bytes</li>
 *  <li><strong>{@link file_src_error}</strong> Upload error code</li>
 *  <li><strong>{@link file_is_image}</strong> Boolean flag, true if the file is a supported image type</li>
 * </ul>
 * If the file is a supported image type (and <i>open_basedir</i> restrictions allow it)
 * <ul>
 *  <li><strong>{@link image_src_x}</strong> Source file width in pixels</li>
 *  <li><strong>{@link image_src_y}</strong> Source file height in pixels</li>
 *  <li><strong>{@link image_src_pixels}</strong> Source file number of pixels</li>
 *  <li><strong>{@link image_src_type}</strong> Source file type (png, jpg, gif or bmp)</li>
 *  <li><strong>{@link image_src_bits}</strong> Source file color depth</li>
 * </ul>
 * <strong>Values that can be read after calling {@link process}()</strong>
 * <ul>
 *  <li><strong>{@link file_dst_path}</strong> Destination file path</li>
 *  <li><strong>{@link file_dst_name_body}</strong> Destination file name body</li>
 *  <li><strong>{@link file_dst_name_ext}</strong> Destination file extension</li>
 *  <li><strong>{@link file_dst_name}</strong> Destination file name</li>
 *  <li><strong>{@link file_dst_pathname}</strong> Destination file complete path and name</li>
 * </ul>
 * If the file is a supported image type
 * <ul>
 *  <li><strong>{@link image_dst_x}</strong> Destination file width</li>
 *  <li><strong>{@link image_dst_y}</strong> Destination file height</li>
 *  <li><strong>{@link image_convert}</strong> Destination file format</li>
 * </ul>
 ...
 * <ul>
 *  <li><strong>v 0.32</strong> 15/01/2013<br>
 ...
 *  <li><strong>v 0.31</strong> 11/04/2011<br>
 ...
 *  <li><strong>v 0.30</strong> 05/09/2010<br>
 ...
 *  <li><strong>v 0.29</strong> 03/02/2010<br>
 ...
 *   - improved logging</li>
 *  <li><strong>v 0.28</strong> 10/08/2009<br>
 ...
 *  <li><strong>v 0.27</strong> 14/05/2009<br>
 ...
 *  <li><strong>v 0.26</strong> 13/11/2008<br>
...
class Xmf_Uploader
{
    ...
    public function __construct($file, $lang = 'en_GB')
    {
        ...
        if (empty($this->log)) {
            ...
            $this->log .= '-&nbsp;open_basedir            : ' .
                          (!empty($open_basedir) ? $open_basedir : 'no restriction') . '<br />';
        ...
        if (!is_array($file)) {
            if (empty($file)) {
                ...
                if (substr($file, 0, 4) == 'php:') {
                    ...
                    $this->log .= '<strong>' . $this->translate("source is a PHP stream") . ' ' . $file . '</strong><br />';
        ...
        if ($this->uploaded) {
            $this->log .= '<strong>determining MIME type</strong><br />';
                ...
                if ($this->mime_getimagesize) {
                    ...
                    if (is_array($info) && array_key_exists('mime', $info)) {
                        ...
                        if (empty($this->file_src_mime)) {
                            ...
                            $mime = (is_array($info) &&
                                     array_key_exists(2, $info) ? $info[2] : null); // 1 = GIF, 2 = JPG, 3 = PNG
                            $this->file_src_mime = ($mime == IMAGETYPE_GIF ? 'image/gif' : ($mime ==
                                                                                            IMAGETYPE_JPEG ? 'image/jpeg' : ($mime ==
                                                                                                                             IMAGETYPE_PNG ? 'image/png' : ($mime ==
                                                                                                                                                            IMAGETYPE_BMP ? 'image/bmp' : null))));
                        }
                        $this->log .= '&nbsp;&nbsp;&nbsp;&nbsp;MIME type detected as ' .
            ...
            if ($this->file_src_mime == 'application/octet-stream' || !$this->file_src_mime ||
                !is_string($this->file_src_mime) || empty($this->file_src_mime) ||
                strpos($this->file_src_mime, '/') === false
            ) {
            ...
            $this->log .= '<strong>source variables</strong><br />';
     ...
     */
    private function translate($str, $tokens = array())
    {
    ...
    private function getcolors($color)
    {
        ...
        if (strlen($color) == 3) {
            $color = str_repeat(substr($color, 0, 1), 2) .
                     str_repeat(substr($color, 1, 1), 2) . str_repeat(substr($color, 2, 1), 2);
        }
     ...
     */
    private function getoffsets($offsets, $x, $y, $round = true, $negative = true)
    {
        if (!is_array($offsets)) {
     ...
     */
    private function imagetransfer($src_im, $dst_im)
    {
     ...
     *
     * @param  resource $dst_im Destination image
     * @param  resource $src_im Overlay image
     ...
     * @return resource Destination image
     */
    private function imagecopymergealpha(&$dst_im, &$src_im, $dst_x, $dst_y, $src_x, $src_y, $src_w, $src_h, $pct = 0)
    {
        $dst_x = (int)$dst_x;
        $dst_y = (int)$dst_y;
        $src_x = (int)$src_x;
     ...
     *
     * @return bool|null|string Optional content of the image
     */
    public function process($server_path = null)
    {
        $f= null;
        $image_manipulation=null;
        $image_src=null;
        $tint_red=null;
                $tint_green=null;
        $tint_blue=null;
        ...
        if ($this->processed) {
            ...
            $image_manipulation = ($this->file_is_image && ($this->image_resize || $this->image_convert != '' ||
                                                            ...
                                                            $this->image_pixelate || $this->image_unsharp ||
                                                            !empty($this->image_text) || $this->image_greyscale ||
                                                            $this->image_negative || !empty($this->image_watermark) ||
                                                            is_numeric($this->image_rotate) ||
                                                            is_numeric($this->jpeg_size) || !empty($this->image_flip) ||
                                                            !empty($this->image_crop) || !empty($this->image_precrop) ||
                                                            !empty($this->image_border) ||
                                                            !empty($this->image_border_transparent) ||
                                                            $this->image_frame > 0 || $this->image_bevel > 0 ||
                ...
                if (!$this->file_auto_rename) {
                    ...
                    if ($file_src_name_ext != $this->file_src_name_ext) {
                        if (substr($this->file_dst_name_body, -1 - strlen($this->file_src_name_ext)) ==
                            ...
                            $body = substr($this->file_dst_name_body, 0,
        ...
        if ($this->processed) {
            ...
            if (!$return_mode) {
                ...
                if ($this->processed && !($f = @fopen($this->file_dst_path . $hash . (!empty($this->file_dst_name_ext) ?
                    ...
                    if ($this->dir_auto_chmod) {
                        ...
                        if (!@chmod($this->file_dst_path, $this->dir_chmod)) {
                            ...
                            $this->log .= ' success<br />';
                            if (!($f = @fopen($this->file_dst_path . $hash . (!empty($this->file_dst_name_ext) ?
                                    '.' . $this->file_dst_name_ext : ''), 'a+'))
                            ) { // we re-check
                                $this->processed = false;
                                $this->error = $this->translate('destination_dir_write');
                    ...
                    @unlink($this->file_dst_path . $hash .
                            (!empty($this->file_dst_name_ext) ? '.' . $this->file_dst_name_ext : ''));
                }
                ...
                if (!$this->no_upload_check && empty($this->file_src_temp) && !@file_exists($this->file_src_pathname)) {
                    ...
                    $hash = md5($this->file_dst_name_body . rand(1, 1000));
                    if (move_uploaded_file($this->file_src_pathname, $this->file_dst_path . $hash .
            ...
            if ($image_manipulation) {
                ...
                if ($this->processed && $image_src) {
                    ...
                    if ($this->image_convert != 'png' && $this->image_convert != 'gif' &&
                        !empty($this->image_default_color) && empty($this->image_background_color)
                    ) {
                        ...
                        if ($ct < 0 || $cr < 0 || $cb < 0 || $cl < 0) {
                            ...
                            if ($cr < 0) {
                                imagefilledrectangle($tmp,
                                        $this->image_src_x + $cr, 0, $this->image_src_x, $this->image_src_y, $fill);
                            }
                            if ($cb < 0) {
                                imagefilledrectangle($tmp, 0,
                                        $this->image_src_y + $cb, $this->image_src_x, $this->image_src_y, $fill);
                            }
                            if ($cl < 0) {
                    ...
                    if ($this->image_resize) {
                        ...
                        } else if ($this->image_ratio || $this->image_ratio_crop || $this->image_ratio_fill ||
                    ...
                    if ((!empty($this->image_crop) || !is_null($ratio_crop))) {
                        ...
                        if ($ct < 0 || $cr < 0 || $cb < 0 || $cl < 0) {
                            ...
                            if ($cr < 0)
                                imagefilledrectangle($tmp,
                                        $this->image_dst_x + $cr, 0, $this->image_dst_x, $this->image_dst_y, $fill);
                            if ($cb < 0)
                                imagefilledrectangle($tmp, 0,
                                        $this->image_dst_y + $cb, $this->image_dst_x, $this->image_dst_y, $fill);
                            if ($cl < 0)
                            ...
                            for ($x = 0; $x < $this->image_dst_x; $x++) {
                                for ($y = 0; $y < $this->image_dst_y; $y++) {
                                    if ($this->image_rotate == 90) {
                                        ...
                                        imagecopy($tmp, $image_dst, $x, $y, $this->image_dst_x - $x - 1,
                    ...
                    if ((is_numeric($this->image_pixelate) && $this->image_pixelate > 0)) {
                        ...
                        if ($gd_version >= 2) {
                            imagecopyresampled($filter, $image_dst, 0, 0, 0, 0, round($this->image_dst_x /
                                                                                      $this->image_pixelate), round($this->image_dst_y /
                                                                                                                    $this->image_pixelate), $this->image_dst_x, $this->image_dst_y);
                            imagecopyresampled($image_dst, $filter, 0, 0, 0, 0, $this->image_dst_x, $this->image_dst_y, round($this->image_dst_x /
                                                                                                                              $this->image_pixelate), round($this->image_dst_y /
                                                                                                                                                            $this->image_pixelate));
                        } else {
                            imagecopyresized($filter, $image_dst, 0, 0, 0, 0, round($this->image_dst_x /
                                                                                    $this->image_pixelate), round($this->image_dst_y /
                                                                                                                  $this->image_pixelate), $this->image_dst_x, $this->image_dst_y);
                            imagecopyresized($image_dst, $filter, 0, 0, 0, 0, $this->image_dst_x, $this->image_dst_y, round($this->image_dst_x /
                                                                                                                            $this->image_pixelate), round($this->image_dst_y /
                                                                                                                                                          $this->image_pixelate));
                        }
                        imagedestroy($filter);
                    ...
                    if ($gd_version >= 2 && $this->image_unsharp && is_numeric($this->image_unsharp_amount) &&
                        is_numeric($this->image_unsharp_radius) && is_numeric($this->image_unsharp_threshold)
                    ) {
                            ...
                            if (function_exists('imageconvolution')) { // PHP >= 5.1
                                ...
                                for ($i = 0; $i < $this->image_unsharp_radius; $i++) {
                                    imagecopy($blur, $image_dst, 0, 0, 1, 0,
                                            $this->image_dst_x - 1, $this->image_dst_y); // left
                                    ...
                                    $this->imagecopymergealpha($blur, $canvas, 0, 0, 0, 1, $this->image_dst_x,
                                            $this->image_dst_y - 1, 33.33333); // up
                            ...
                            if ($this->image_unsharp_threshold > 0) {
                                ...
                                for ($x = 0; $x < $this->image_dst_x; $x++) {
                                    for ($y = 0; $y < $this->image_dst_y; $y++) {
                                        $p_orig = imagecolorsforindex($image_dst, imagecolorat($image_dst, $x, $y));
                                        $p_blur = imagecolorsforindex($blur, imagecolorat($blur, $x, $y));
                                        $p_new['red'] = ($this->image_unsharp_amount *
                                                         ($p_orig['red'] - $p_blur['red'])) + $p_orig['red'];
                                        if ($p_new['red'] > 255) {
                                            $p_new['red'] = 255;
                                        } elseif ($p_new['red'] < 0) {
                                            $p_new['red'] = 0;
                                        }
                                        $p_new['green'] = ($this->image_unsharp_amount *
                                                           ($p_orig['green'] - $p_blur['green'])) + $p_orig['green'];
                                        if ($p_new['green'] > 255) {
                                            $p_new['green'] = 255;
                                        } elseif ($p_new['green'] < 0) {
                                            $p_new['green'] = 0;
                                        }
                                        $p_new['blue'] = ($this->image_unsharp_amount *
                                                          ($p_orig['blue'] - $p_blur['blue'])) + $p_orig['blue'];
                                        if ($p_new['blue'] > 255) {
                                            $p_new['blue'] = 255;
                                        } elseif ($p_new['blue'] < 0) {
                                            $p_new['blue'] = 0;
                    ...
                    // add color overlay
                    if ($gd_version >= 2 &&
                        (is_numeric($this->image_overlay_opacity) && $this->image_overlay_opacity > 0 &&
                         !empty($this->image_overlay_color))
                    ) {
                    ...
                    if ($gd_version >= 2 &&
                        ($this->image_negative || $this->image_greyscale || is_numeric($this->image_threshold) ||
                        ...
                        for ($y = 0; $y < $this->image_dst_y; $y++) {
                            for ($x = 0; $x < $this->image_dst_x; $x++) {
                                if ($this->image_greyscale) {
                                    ...
                                    $r = $g = $b = round((0.2125 * $pixel['red']) + (0.7154 * $pixel['green']) +
                                                         (0.0721 * $pixel['blue']));
                    ...
                    if ($gd_version >= 2 && !empty($this->image_border)) {
                        ...
                        imagecopy($tmp, $image_dst, $cl, $ct, 0, 0, $this->image_dst_x - $cr - $cl,
                    ...
                    if ($gd_version >= 2 && !empty($this->image_border_transparent)) {
                        ...
                        imagecopy($tmp, $image_dst, $cl, $ct, $cl, $ct, $this->image_dst_x - $cr - $cl,
                                $this->image_dst_y - $cb - $ct);
                        ...
                        for ($y = $ct - 1; $y >= 0; $y--) {
                            ...
                            for ($x = $il; $x < $this->image_dst_x - $ir; $x++) {
                                ...
                                if ($alpha > 0) {
                                    if ($alpha > 1)
                                        $alpha = 1;
                                    $color = imagecolorallocatealpha($tmp, $pixel['red'], $pixel['green'], $pixel['blue'], round((1 -
                                                                                                                                  $alpha) *
                                                                                                                                 127));
                    ...
                    if ($gd_version >= 2 && is_numeric($this->image_frame)) {
                        ...
                        $tmp = $this->imagecreatenew($this->image_dst_x, $this->image_dst_y);
                        imagecopy($tmp, $image_dst, $nb, $nb, 0, 0, $this->image_dst_x - ($nb * 2),
                        ...
                        for ($i = 0; $i < $nb; $i++) {
                            ...
                            if ($this->image_frame == 1) {
                                ...
                                imageline($tmp, $this->image_dst_x - $i - 1, $this->image_dst_y - $i - 1,
                                        $this->image_dst_x - $i - 1, $i, $c);
                                imageline($tmp, $this->image_dst_x - $i - 1, $this->image_dst_y - $i - 1, $i,
                                        $this->image_dst_y - $i - 1, $c);
                                imageline($tmp, $i, $i, $i, $this->image_dst_y - $i - 1, $c);
                            } else {
                                imageline($tmp, $i, $i, $this->image_dst_x - $i - 1, $i, $c);
                                imageline($tmp, $this->image_dst_x - $nb + $i, $this->image_dst_y - $nb + $i,
                                        $this->image_dst_x - $nb + $i, $nb - $i, $c);
                                imageline($tmp, $this->image_dst_x - $nb + $i, $this->image_dst_y - $nb + $i, $nb - $i,
                    ...
                    if ($gd_version >= 2 && $this->image_bevel > 0) {
                        ...
                        for ($i = 0; $i < $this->image_bevel; $i++) {
                            ...
                            imageline($tmp, $this->image_dst_x - $i - 1, $this->image_dst_y - $i,
                    ...
                    if ($this->image_watermark != '' && file_exists($this->image_watermark)) {
                        ...
                        if ($watermark_checked) {
                            ...
                            if ((!$this->image_watermark_no_zoom_out && ($watermark_dst_width > $this->image_dst_x ||
                    ...
                    if (!empty($this->image_text)) {
                        ...
                        foreach ($text as $k => $v) {
                            if ($this->image_text_direction == 'v') {
                                ...
                                $text_height += $line_height + ($k < (sizeof($text) -
                        ...
                        */
                        ...
                        if (!empty($this->image_text_background)) {
                            ...
                            if ($gd_version >= 2 && (is_numeric($this->image_text_background_opacity)) &&
                                $this->image_text_background_opacity >= 0 && $this->image_text_background_opacity <= 100
                            ) {
                                ...
                                imagefilledrectangle($image_dst, $text_x, $text_y, $text_x + $text_width,
                        ...
                        if ($gd_version >= 2 && (is_numeric($this->image_text_opacity)) &&
                            $this->image_text_opacity >= 0 && $this->image_text_opacity <= 100
                        ) {
                            if ($t_width < 0)
                                $t_width = 0;
                            if ($t_height < 0)
                            ...
                            foreach ($text as $k => $v) {
                                if ($this->image_text_direction == 'v') {
                                    imagestringup($filter, $this->image_text_font, $k * ($line_width + ($k > 0 && $k <
                                                                                                                  (sizeof($text)) ? $this->image_text_line_spacing : 0)),
                                            $text_height - (2 * $this->image_text_padding_y) -
                                            ($this->image_text_alignment == 'l' ? 0 : (($t_height -
                                                                                        strlen($v) * $char_width) /
                                                                                       ($this->image_text_alignment ==
                                                                                        'r' ? 1 : 2))), $v, $text_color);
                                } else {
                                    imagestring($filter, $this->image_text_font, ($this->image_text_alignment ==
                                                                                  'l' ? 0 : (($t_width - strlen($v) *
                                                                                                         $char_width) /
                                                                                             ($this->image_text_alignment ==
                                                                                              'r' ? 1 : 2))), $k *
                                                                                                              ($line_height +
                                                                                                               ($k >
                                                                                                                0 &&
                                                                                                                $k <
                                                                                                                (sizeof($text)) ? $this->image_text_line_spacing : 0)), $v, $text_color);
                                }
                            }
                            ...
                            foreach ($text as $k => $v) {
                                if ($this->image_text_direction == 'v') {
                                    imagestringup($image_dst, $this->image_text_font, $text_x + $k * ($line_width +
                                                                                                      ($k > 0 && $k <
                                                                                                                 (sizeof($text)) ? $this->image_text_line_spacing : 0)),
                                    ...
                                    imagestring($image_dst, $this->image_text_font, $text_x +
                                                                                    ($this->image_text_alignment ==
                                                                                     'l' ? 0 : (($t_width - strlen($v) *
                                                                                                            $char_width) /
                                                                                                ($this->image_text_alignment ==
                                                                                                 'r' ? 1 : 2))),
                                            $text_y + $k * ($line_height + ($k > 0 && $k <
                                                                                      (sizeof($text)) ? $this->image_text_line_spacing : 0)), $v, $text_color);
                                }
                            }
                        }
                    ...
                    if ($this->image_reflection_height) {
                        ...
                        $tmp = $this->imagecreatenew($this->image_dst_x,
                                $this->image_dst_y + $image_reflection_height + $this->image_reflection_space, true);
                        $transparency = $this->image_reflection_opacity;

                        // copy the original image
                        imagecopy($tmp, $image_dst, 0, 0, 0, 0, $this->image_dst_x, $this->image_dst_y +
                                                                                    ($this->image_reflection_space <
                                                                                     0 ? $this->image_reflection_space : 0));
                        ...
                        for ($y = 0; $y < $image_reflection_height; $y++) {
                            for ($x = 0; $x < $this->image_dst_x; $x++) {
                                $pixel_b = imagecolorsforindex($tmp, imagecolorat($tmp, $x,
                                        $y + $this->image_dst_y + $this->image_reflection_space));
                                $pixel_o = imagecolorsforindex($image_dst, imagecolorat($image_dst, $x,
                                        $this->image_dst_y - $y - 1 +
                                        ($this->image_reflection_space < 0 ? $this->image_reflection_space : 0)));
                                $alpha_o = 1 - ($pixel_o['alpha'] / 127);
                                $alpha_b = 1 - ($pixel_b['alpha'] / 127);
                                $opacity = $alpha_o * $transparency / 100;
                                if ($opacity > 0) {
                                    $red = round((($pixel_o['red'] * $opacity) + ($pixel_b['red']) * $alpha_b) /
                                                 ($alpha_b + $opacity));
                                    $green = round((($pixel_o['green'] * $opacity) + ($pixel_b['green']) * $alpha_b) /
                                                   ($alpha_b + $opacity));
                                    $blue = round((($pixel_o['blue'] * $opacity) + ($pixel_b['blue']) * $alpha_b) /
                                                  ($alpha_b + $opacity));
                                    ...
                                    imagesetpixel($tmp, $x,
                                            $y + $this->image_dst_y + $this->image_reflection_space, $color);
                                }
                            }
                            if ($transparency > 0)
                                $transparency = $transparency - ($this->image_reflection_opacity /
                    ...
                    if ($gd_version >= 2 && is_numeric($this->image_opacity) && $this->image_opacity < 100) {
                        ...
                        for ($y = 0; $y < $this->image_dst_y; $y++) {
                            for ($x = 0; $x < $this->image_dst_x; $x++) {
                                $pixel = imagecolorsforindex($image_dst, imagecolorat($image_dst, $x, $y));
                                $alpha = $pixel['alpha'] + round((127 - $pixel['alpha']) *
                                                                 (100 - $this->image_opacity) / 100);
                                if ($alpha > 127)
                                    $alpha = 127;
                                if ($alpha > 0) {
                    ...
                    if (is_numeric($this->jpeg_size) && $this->jpeg_size > 0 &&
                        ($this->image_convert == 'jpeg' || $this->image_convert == 'jpg')
                    ) {
                                ...
                                for ($x = 0; $x < $this->image_dst_x; $x++) {
                                    for ($y = 0; $y < $this->image_dst_y; $y++) {
                                        if ($mask[$x][$y] > 0) {
                                            ...
                                            $pixel['green'] = round(($pixel['green'] * (1 - $alpha) +
                                                                     $green * ($alpha)));
        ...
        if ($this->processed) {
            ...
            $this->log .= '- <strong>error</strong>: ' . $this->error . '<br />';
        }
        ...
        while ($Y >= 0) {
            ...
            while ($X < $bmp['width']) {
                if ($bmp['bits_per_pixel'] == 24)
                    $color = unpack("V", substr($im, $P, 3) . $vide); elseif ($bmp['bits_per_pixel'] == 16) {
